...
namespace Inventory.DAL.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockTransactions_Stores_FromStoreId",
                        column: x => x.FromStoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockTransactions_Stores_ToStoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_FromStoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_ToStoreId",
                table: "StockTransactions",
                column: "ToStoreId");
        }
